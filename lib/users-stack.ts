...
export class UserStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const api: apigateway.RestApi = new apigateway.RestApi(
      ...
      components.addMethod("POST", new apigateway.LambdaIntegration(createUsers)); 
      ...
      components3.addMethod("GET", new apigateway.LambdaIntegration(getFaculties));

      const components4 = api.root.addResource("programs");
      components4.addMethod("GET", new apigateway.LambdaIntegration(getPrograms));

      const components5 = api.root.addResource("standings");
      components5.addMethod("GET", new apigateway.LambdaIntegration(getStandings));

      const components6 = api.root.addResource("socials");
      components6.addMethod("GET", new apigateway.LambdaIntegration(getSocials));
  }
}
